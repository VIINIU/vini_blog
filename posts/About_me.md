...
- **2022.03 - Present**
  - 중앙대학교 창의ICT공학대학 전자전기공학 학부생
  - Undergraduate Student, School of Electrical and Electronics Engineering, Chung-Ang University

- **2023.09 - Present**
  - 중앙대학교 하드웨어 컴퓨터 중앙동아리 CECOM 부원
  - HW & Computer Club CECOM Member

- **2024.01 - 2024.12**
  - 중앙대학교 하드웨어 컴퓨터 중앙동아리 부회장
  - HW & Computer Club CECOM Vice President

- **2025.09 - Present**
  - GDGoC 중앙대학교 멤버
  - Google Developers Group on Campus Chung-Ang Univ. member

## 📚 Studies & Mentoring

- **Verilog 스터디 (2025.03 - 2025.09)**
  - 1bit-registor부터 간단한 ALU를 설계, 나아가 몇가지 간단한 연산을 수행하는 CPU를 구상
  - Verilog Study: Designed from 1-bit register to ALU, conceptualizing a simple CPU

- **ESP32 멘토링 (2024.09 - 2024.12 / 멘토)**
  - 동아리에서 진행한 ESP32 활용 방법에 관한 멘토링에서 멘토를 맡아 토이프로젝트 형식의 멘토링을 진행
  - ESP32 Mentoring: Led ESP32 toy project mentoring for new club members
