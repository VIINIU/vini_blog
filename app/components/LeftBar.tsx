      ...
      <div className="flex flex-col items-center text-center gap-5 w-full">
        ...
        <div className="flex flex-col items-center text-center gap-1 text-sm">
          ...
          <div className="flex flex-col items-center">
            <p>
              <a href="https://viniu.info/post?category=AI%20%26%20Deep%20Learning" target="_blank" className="hover:text-blue-500 transition-colors duration-200">On-Device AI</a>
              <br />
              <a href="https://viniu.info/post?category=Embedded%20%26%20IoT" target="_blank" className="hover:text-blue-500 transition-colors duration-200">Embedded System</a>
            </p>
          </div>
        </div>
